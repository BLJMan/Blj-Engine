...
class Note extends FlxSprite
{
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, noteType:Int = 0, ?editor:Bool = false)
	{
		super();
	...
	override function update(elapsed:Float)
	{
		...
		if (mustPress)
		{
			...
			if (strumTime < Conductor.songPosition - (Conductor.safeZoneOffset / 2)  && !wasGoodHit)
				tooLate = true;
		}
		else
		{
