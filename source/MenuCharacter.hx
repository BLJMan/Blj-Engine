...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'spooky' => new CharacterSetting(20, 40, 1.15),
		'pico' => new CharacterSetting(0, 10, 1.1, true),
		'mom' => new CharacterSetting(-30, 140, 0.85),
		'parents-christmas' => new CharacterSetting(100, 130, 1.8),
		'senpai' => new CharacterSetting(-40, -45, 1.4),
		'tankman' => new CharacterSetting(-70, -20, 1)
	];
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		animation.addByPrefix('bfConfirm', 'BF HEY!!', 24);
		animation.addByPrefix('gf-left', 'GF Dancing Beat WHITE', 24);
		animation.addByPrefix('gf-right', 'GF Dancing Beat WHITE',  24);
		animation.addByPrefix('dad', "Dad idle dance BLACK LINE", 24);
		animation.addByPrefix('spooky-left', 'spooky dance idle BLACK LINES', 24);
		animation.addByPrefix('spooky-right', 'spooky dance idle BLACK LINES', 24);
